...
Seluruh aset publik yang tersedia di ZIP Laravel pertama dimigrasikan ke path yang sama di `public/images`, `public/icons`, dan `public/storage`. Konten statis halaman lama juga dipindahkan ke React. Lihat `MIGRATION_NOTES.md` dan folder `legacy/` untuk audit migrasi.
